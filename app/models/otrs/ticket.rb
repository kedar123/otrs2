class OTRS::Ticket < OTRS
  ...
  def self.create_ticket
    tick = OTRS::Ticket.new()
    tick.Title = "title11"
    tick.Title = "title11"
    
    
   # rllib.quote(" \"Title\"")+":"+urllib.quote(" \""+subject+"\"")+","+urllib.quote(" \"Queue\"")+":"+urllib.quote(" \""+queue+"\"")+","+urllib.quote(" \"PriorityID\"")+":"+urllib.quote(" \""+priority_ids+"\"")+","+urllib.quote(" \"State\"")+":"+urllib.quote(" \""+state+"\"")+","+urllib.quote(" \"CustomerUser\"")+":"+urllib.quote(" \""+customer_user+"\"")+","+urllib.quote(" \"Created\"")+":"+urllib.quote(" \""+create_date+"\"")+","+urllib.quote(" \"OwnerID\"")+":"+urllib.quote(" \"1\"")+","+urllib.quote(" \"UserID\"")+":"+urllib.quote(" \"1\"")+","+urllib.quote(" \"Lock\"")+":"+urllib.quote(" \"unlock\"")+"}")
